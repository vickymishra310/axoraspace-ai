...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="relative z-10 flex flex-col items-center text-center px-4 pt-32 pb-16 sm:px-6 sm:pt-[200px] sm:pb-[80px] md:pt-[280px] md:pb-[102px]">
      <motion.div
      ...
      >
        ...
        {/* Heading */}
        <h1
          className="max-w-[700px] text-[28px] sm:text-[36px] md:text-[56px] font-medium leading-[1.28] tracking-[-0.02em]"
          style={{
        ...
        {/* Subtitle */}
        <p className="max-w-[680px] text-[14px] sm:text-[15px] leading-relaxed text-foreground/70">
